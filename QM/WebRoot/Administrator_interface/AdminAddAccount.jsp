...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/AddAccountServlet" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>添加账单信息</p>
					<p>
						账单时间：<input type="text" value="" name="timer" required="required" title="账单时间格式：2019-01-05" placeholder="2019-01-05" />
					</p>
					<p>
						账单标题：<input type="text" value="" name="title" required="required" title="请输入账单标题" />
					</p>
					<p>
						账单链接：<input type="text" value="account_list.jsp" name="url" required="required"/>
					</p>
					<p>
						账单照片：<input type="file" value="" name="accountimg" required="required" title="请输入账单相关证明图片:xxx.jpg" />
					</p>

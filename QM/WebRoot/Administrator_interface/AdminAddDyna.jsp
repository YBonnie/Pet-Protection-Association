...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/AddDynaServlet" method="post" enctype="multipart/form-data">
				<div class="newsBox" style="margin-top:70px;">
					<p>添加协会动态信息</p>
					
					<p>
						动态标题：<input type="text" value="" name="dynamics_title" required="required" title="请输入协会动态标题" />
					</p>
					<p>
						动态时间：<input type="text" value="" name="dynamics_time" placeholder="2019-01-05" required="required" title="协会动态时间格式：2019-01-05"/>
					</p>
					<p>
						动态链接：<input type="text" value="association_Dynamics_content1.jsp" name="dynamics_content" />
					</p>
					<p>
						动态内容：<input type="text" value="" name="dynamics_allcont" style="height:100px" required="required" title="请输入动态内容"/>
					</p>
					<p>
						动态照片：<input type="file" value="" name="dynamics_img" required="required" title="请输入协会动态图片:xxx.jpg" />
					</p>
					<p class="addNews_box">

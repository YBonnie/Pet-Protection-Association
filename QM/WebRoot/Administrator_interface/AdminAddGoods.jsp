...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/AddGoodsServlet" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>添加商品信息</p>
					<p>
						商品名字：<input type="text" value="" name="name" required="required" title="请输入商品名称：xxx" />
					</p>
					<p>
						商品价格：<input type="text" value="" name="price" required="required" title="请输入商品价格：255"/>
					</p>
					<p>
						商品总数：<input type="text" value="" name="total_number" required="required" title="请输入商品总数：25" />
					</p>
					<p>
						商品照片：<input type="file" value="" name="imgurl" required="required" title="请输入商品图片:xxx.jpg"/>
					</p>

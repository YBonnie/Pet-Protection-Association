...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/AddNewsServlet" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>添加新闻信息</p>
					<p>
						新闻照片：<input type="file" value="" name="news_img" required="required" title="新闻图片:xxx.jpg" />
					</p>
					<p>
						新闻标题：<input type="text" value="" name="news_titles" required="required" title="新闻标题：xxx" />
					</p>
					<p>
						新闻时间：<input type="text" value="" name="news_time" required="required" title="新闻时间格式：2019-01-05" placeholder="2019-01-05" />
					</p>
					<p>
						新闻内容：<input type="text" value="" name="news_content" style="height:60px" required="required" title="请输入新闻简介"/>
					</p>
					<p>
						新闻链接：<input type="text" value="news_Center_content1.jsp" name="news_deily_cont" />
					</p>
					<p>
						具体内容：<input type="text" value="" name="news_allcont" style="height:100px" required="required" title="请输入新闻内容"/>
					</p>

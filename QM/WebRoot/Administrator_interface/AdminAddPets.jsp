...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/AddPetsServlet" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>添加宠物信息</p>
					<p>
						宠物属性：<input type="text" value="" name="kind" required="required" title="宠物属性格式：cat / dog" placeholder="cat / dog" />
					</p>
					<p>
						宠物名字：<input type="text" value="" name="name" required="required" title="请输入宠物名字：xxx" />
					</p>
					<p>
						宠物年龄：<input type="text" value="" name="age" required="required" title="宠物年龄格式：2个月" />
					</p>
					<p>
						宠物性别：<input type="text" value="" name="sex" required="required" title="宠物性别格式：男  / 女"/>
					</p>
					<p>
						宠物品种：<input type="text" value="" name="type" required="required" title="宠物品种格式：柴犬" />
					</p>
					<p>
						领养状态：<input type="text" value="" name="status" placeholder="0 / 1" required="required" title="领养状态：0 / 1"/>
					</p>
					<p>
						宠物照片：<input type="file" value="" name="imgurl" required="required" title="宠物图片：xxx.jpg" />
					</p>
					<p class="addNews_box">
						<input type="submit" class="addNewsBtn" name="addNewsBtn" id="addNewsBtn" value="添   加" /> 

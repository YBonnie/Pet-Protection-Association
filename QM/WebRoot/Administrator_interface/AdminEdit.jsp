...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/UpDateAdminInfo?id=${admin.id }" method="admin">
				<div class="userBox">
					<p>请修改用户信息</p>
					<input type="hidden" name="id" value="${admin.id }">
					<p>
						管理人姓名：<input type="text" value="${admin.ad_name }" name="ad_name" />
					</p>
					<p>
						管理人密码：<input type="text" value="${admin.ad_password }" name="ad_password" />
					</p>
					<p>
						管理人电话：<input type="text" value="${admin.ad_phone }" name="ad_phone" />
					</p>
					<p class="addNews_box">

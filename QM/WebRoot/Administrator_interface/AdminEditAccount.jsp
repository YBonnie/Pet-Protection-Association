...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/UpDateAccountInfo?id=${account.id }" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>请修改协会账单信息</p>
					<input type="hidden" name="id" value="${account.id }">
				
					<p>
						账单时间：<input type="text" value="${account.timer }" name="timer" />
					</p>
					<p>
						账单标题：<input type="text" value="${account.title }" name="title" />
					</p>
					<p>
						账单链接：<input type="text" value="${account.url }" name="url" style="height:60px;" />
					</p>
					<p>
						账单照片： <img src="/QM/ImgServlet?imgurl=${account.accountimg}" style="cursor: pointer; width:100px;height:50px;"/>
						        <input type="file" value="" name="accountimg" />
					</p>		
					<p class="addNews_box">

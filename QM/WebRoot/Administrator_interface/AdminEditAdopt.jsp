...
<body>
	...
	<!--logo栏-->
		...
		<div class="content_2">
			<form action="/QM/UpDateAdoptInfo?id=${adopt.id }" method="post">
				<div class="newsBox">
					<p>请修改用户信息</p>
					<input type="hidden" name="id" value="${adopt.id }">
					<p>
						客户姓名：<input type="text" value="${adopt.aptName }" name="aptName" />
					</p>
					<p>
						个人性别：<input type="text" value="${adopt.aptGender }" name="aptGender" />
					</p>
					<p>
						居住地址：<input type="text" value="${adopt.aptAddress }" name="aptAddress" />
					</p>
					<p>
						联系方式：<input type="text" value="${adopt.aptMobile }" name="aptMobile" />
					</p>
					<p>
						电子邮箱：<input type="text" value="${adopt.aptEmail }" name="aptEmail" />
					</p>
					
					<p>
						宠物名字：<input type="text" value="${adopt.pet_name }" name="pet_name" />
					</p>
					<p>
						宠物芯片：<input type="text" value="${adopt.pet_id }" name="pet_id" />
					</p>
					<p class="addNews_box">

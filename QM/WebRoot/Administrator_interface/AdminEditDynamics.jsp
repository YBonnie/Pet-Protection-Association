...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/UpDateDynamicsInfo?id=${dynamics.id }" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>请修改协会动态信息</p>
					<input type="hidden" name="id" value="${dynamics.id }">
					<p>
						动态标题：<input type="text" value="${dynamics.dynamics_title }" name="dynamics_title" />
					</p>
					<p>
						动态时间：<input type="text" value="${dynamics.dynamics_time }" name="dynamics_time" />
					</p>
					<p>
						动态链接：<input type="text" value="${dynamics.dynamics_content }" name="dynamics_content" />    
					</p>
					<p>
						动态内容：<input type="text" value="${dynamics.dynamics_allcont }" name="dynamics_allcont" />    
					</p>
					<p>
						动态图片：<img src="/QM/ImgServlet?imgurl=${dynamics.dynamics_img}" style="cursor: pointer; width:100px;height:50px;"/>
						        <input type="file" value="" name="dynamics_img" />
					</p>				
					<p class="addNews_box">

...
<body>
	<div class="main">
		...
		<div class="content_2">
			<form action="/QM/UpDateGoodsInfo?id=${goods.id }" method="post" enctype="multipart/form-data">
				<div class="newsBox">
					<p>请修改商品信息</p>
					<input type="hidden" name="id" value="${goods.id }">
					<p>
						商品名字：<input type="text" value="${goods.name }" name="name" />
					</p>
					<p>
						商品价格：<input type="text" value="${goods.price }" name="price" />
					</p>
					<p>
						商品总数：<input type="text" value="${goods.total_number }" name="total_number" />
					</p>
					<p>
						商品照片： <img src="/QM/ImgServlet?imgurl=${goods.imgurl}" style="cursor: pointer; width:100px;height:50px;"/>

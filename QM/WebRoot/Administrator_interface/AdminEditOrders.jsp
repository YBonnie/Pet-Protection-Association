...
<body>
	...
	<!--logo栏-->
		...
		<div class="content_2">
			<form action="/QM/UpDateOrdersInfo?id=${order.id }" method="post">
				<div class="userBox">
					<p>请修改订单信息</p>
					<input type="hidden" name="id" value="${order.id }">
					<p>
						收货姓名：<input type="text" value="${order.receivername }" name="receivername" />
					</p>
					<p>
						联系方式：<input type="text" value="${order.receiverphone }" name="receiverphone" />
					</p>
					<p>
						收货地址：<input type="text" value="${order.receiverinfo }" name="receiverinfo" />
					</p>
					<p>
						支付情况：<input type="text" value="${order.paystate }" name="paystate" />
					</p>

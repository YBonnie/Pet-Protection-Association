...
<body>
			...
			<div class="breadcrumbs wow bounceInLeft" data-wow-duration="2s">
				<a href="/QM/IndexList">&nbsp;&nbsp;首页&nbsp;&nbsp;</a>
				<span> > </span>
				<a class="active" href="sign_In.jsp">&nbsp;&nbsp;会员信息修改&nbsp;&nbsp;</a>
			</div>

			<!--content-->
			<div class="content wow fadeInUp" data-wow-duration="2s">
				<h1 class="wow fadeInUp" data-wow-duration="4s">会员信息修改</h1>
				<div class="register wow fadeInUp" data-wow-duration="4s">
					<div class="register_box wow bounce" data-wow-duration="4s">
						<!--用户账户和密码的表单-->
						<h2 class="h2_1">欢迎您，请修改信息</h2>
							<form id="form2" runat="server" name="form2" action="/QM/UpdateUser?id=${user.id }" onsubmit="" method="POST">
							<input type="hidden" name="id" value="${user.id }">
								<p class="p7"><span>登录账户：</span><input type="text" name="username" id="" value="${user.username}" /></p>
								<p class="p8"><span>用户密码：</span><input type="password" name="password1" id="" value="${user.password1 }" /></p>
								<p class="p10"><span>真实姓名：</span><input type="text" name="truename" id="" value="${user.truename }" /></p>
								<p class="p11"><span>身份证号：</span><input type="text" name="chineseId" id="" value="${user.chineseId }" /></p>
								<p class="p12"><span>电子邮箱：</span><input type="text" name="email" id="" value="${user.email }" /></p>
								<p class="p13"><span>联系方式：</span><input type="text" name="phone" id="" value="${user.phone }" /></p>
								<p>
									<input type="submit" name="" id="register_submit" class="register_submit" value="修改" />

		...
		<script src="js/index.js"></script>
			...
			function changePage(obj){
  			if(isNaN(obj.value)){
  				...
  				window.location.href="/QM/AccountList?thispage="+obj.value;
  			}
  		}
  		</script>
</head>
<body>
		...
		<div class="navBar wow fadeInUp" data-wow-duration="2s">
			...
			<!--面包屑-->
			<div class="breadcrumbs wow bounceInLeft" data-wow-duration="4s">
				<a href="/QM/IndexList">&nbsp;&nbsp;首页&nbsp;&nbsp;</a>
				<span> > </span>
				<a href="/QM/BazaarList?thispage=1">&nbsp;&nbsp;线上义卖&nbsp;&nbsp;</a>
				<span> > </span>
				<a class="active" href="/QM/AccountList?thispage=1">&nbsp;&nbsp;账目明细&nbsp;&nbsp;</a>
			</div>

			<!--content-->
			<div class="content wow fadeInUp" data-wow-duration="4s">
				<h1 class="wow fadeInUp" data-wow-duration="4s">账目明细</h1>
				<div class="account_Details_box" id="account_Details_box">
					<ul class="account_ul">
					
						<c:forEach items="${requestScope.page.list3}"  var="account">
						<li class="account_li wow fadeInUp" data-wow-duration="4s">
						<span class="span_2">${account.title}</span>
							<span class="span_1">${account.timer}</span>
							
							<a href="/QM/accountContent?id=${account.id}">
							<span class="span_4">详情</span>
							</a>
							<span class="span_3"><img src="media/images/xiangqing_icon.jpg" alt="" /></span>
						</li>
						 </c:forEach>
					...
					<div class="ep-pages">
					  	...
					  	<a href="/QM/AccountList?thispage=${page.firstpage}">首页</a>
					  	<a href="/QM/AccountList?thispage=${page.prepage}">上一页</a>
					  	...
					  	<c:forEach begin="${begin}" end="${end}" step="1" var="i">
					  		...
					  		<c:if test="${i != page.thispage}">
					  			<a href="/QM/AccountList?thispage=${i}">${i }</a>
					  		</c:if>
					  	</c:forEach>
					  	
					  	<!-- 分页逻辑结束 -->
					  	
					  	<a href="/QM/AccountList?thispage=${page.nextpage }">下一页</a>
					  	<a href="/QM/AccountList?thispage=${page.lastpage }">尾页</a>

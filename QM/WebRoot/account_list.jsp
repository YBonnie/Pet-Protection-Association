...
<body>
			...
			<div class="breadcrumbs wow bounceInLeft" data-wow-duration="4s">
				...
				<a href="/QM/AccountList?thispage=1">&nbsp;&nbsp;账目明细&nbsp;&nbsp;</a>
				<span> > </span>
				<a class="active" href="#">&nbsp;&nbsp;账目清单&nbsp;&nbsp;</a>
			</div>

			<!--content-->
			<div class="content">
				<h1 class="wow fadeInUp" data-wow-duration="4s">账目清单</h1>
				<div class="account_list_box wow fadeInUp" data-wow-duration="4s" id="account_list_box">
					<h2>${requestScope.account.title}</h2>
					<p class="p6">
					   <img src="/QM/ImgServlet?imgurl=${requestScope.account.accountimg}" style="cursor: pointer;width:1100px;height:1500px;" />
					</p>
				</div>

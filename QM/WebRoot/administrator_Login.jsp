...
<body>
	<div class="main">
		...
		<div class="breadcrumbs wow bounceInLeft" data-wow-duration="2s">
			<a href="index.jsp">&nbsp;&nbsp;首页&nbsp;&nbsp;</a> <span> > </span> <a
				class="active" href="sign_In.jsp">&nbsp;&nbsp;管理员登录&nbsp;&nbsp;</a>
		</div>

		<!--content-->
		<div class="content wow fadeInUp" data-wow-duration="4s">
			<h1 class="wow fadeInUp" data-wow-duration="4s">管理员会员登录</h1>
			<div class="administrator_box wow fadeInUp" data-wow-duration="4s">
				<div class="sign_box wow bounce" data-wow-duration="4s">
					<!--用户账户和密码的表单-->
					<h2 class="h2_1">管理员员登录</h2>
					<form id="form2" runat="server" name="form2" action="/QM/AdminLogin" onsubmit="" method="post">
						<div class="user-name">
								...
								<div class="user-pass">
									...
									<input type="password" name="password1" id="password" class="password" required="required" title="密码不能为空哦！" placeholder="请输入密码">
								</div>

								<div class="mr-cf">
									<input type="submit" name="" value="登 录" class="mr-btn">
									<a href="#" class="mr-fr"><input type="reset" name="" id="" value="重置"  class="mr-btn_zhu"/></a>
								</div>
					</form>
				</div>
			</div>
		...
		<div class="footer">
			<div class="footer_box clearfix">
				...
				<a class="btn-select fr" id="btn_select"> <select
					...
					alt="" />
				<p>协会二维码2</p>
				</a> <a class="code fr" href=""><img src="media/images/code1.png"
					alt="" />
				<p>协会二维码1</p>
				</a>
			</div>

			...
			<div class="content wow fadeInUp" data-wow-duration="4s">
				<div class="paragraph wow fadeInUp" data-wow-duration="4s">
					<p class="content-l-title">
						${requestScope.dynamics.dynamics_title}
					</p>
					<p class="content-l-titleS">

					</p>
					<p class="content-l-time">
						发布日期：${requestScope.dynamics.dynamics_time}
					</p>
					<p class="content-l-titleS">
					<img src="/QM/ImgServlet?imgurl=${requestScope.dynamics.dynamics_img}"
						style="cursor: pointer;" />
				    </p>
					 <input id="p_content" type="hidden" value="${requestScope.dynamics.dynamics_allcont}">

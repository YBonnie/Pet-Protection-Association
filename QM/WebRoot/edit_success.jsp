...
<body>
			...
			<div class="navBar wow fadeInUp" data-wow-duration="2s">
				<ul class="nav clearfix">
					...
					<li>
						<a href="/QM/BazaarList">线上义卖</a>
						<ol>
							<li>
								<a href="donation_Account.jsp">募捐账户</a>
							</li>
							<li>
								<a href="account_Details.jsp">账目明细</a>
							</li>
						</ol>
					</li>
					<li>
			...
			<div class="breadcrumbs wow bounceInLeft" data-wow-duration="2s">
				<a href="/QM/IndexList">&nbsp;&nbsp;首页&nbsp;&nbsp;</a>
				<span> > </span>
				<a class="active" href="sign_In.jsp">&nbsp;&nbsp;会员修改信息&nbsp;&nbsp;</a>
			</div>
			...
			<div class="content wow fadeInUp" data-wow-duration="4s">
				...
				<div class="register">
					<div class="register_box">
						<!--用户账户和密码的表单-->
						<h2 class="h2_1">恭喜信息修改成功</h2>
							
								<form id="form2" runat="server" name="form2" action="" onsubmit="" method="get">
						
								<p class="p7"><span>登录账户：</span><input type="text" name="username" id="" value="${requestScope.user.username}" /></p>
								<p class="p8"><span>用户密码：</span><input type="password" name="password1" id="" value="${requestScope.user.password1 }" /></p>
								<p class="p10"><span>真实姓名：</span><input type="text" name="truename" id="" value="${requestScope.user.truename }" /></p>
								<p class="p11"><span>身份证号：</span><input type="text" name="chineseId" id="" value="${requestScope.user.chineseId }" /></p>
								<p class="p12"><span>电子邮箱：</span><input type="text" name="email" id="" value="${requestScope.user.email }" /></p>
								<p class="p13"><span>联系方式：</span><input type="text" name="phone" id="" value="${requestScope.user.phone }" /></p>
								<p>
									<a href="/QM/IndexList"><input type="button" name="" id="register_submit" class="register_submit" value="返回" /></a>

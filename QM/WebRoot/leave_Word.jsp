	...
	<div class="main">
		...
		<div class="navBar wow fadeInUp" data-wow-duration="2s">
			<ul class="nav clearfix">
				...
				<li><a href="/QM/NewsList?thispage=1">新闻中心</a>
					<ol>
		...
		<div class="breadcrumbs wow bounceInLeft" data-wow-duration="2s">
			...
			<span> > </span> 
			<a class="active" href="leave_Word.jsp">&nbsp;&nbsp;留言&nbsp;&nbsp;</a>
		</div>
		...
		<div class="content wow fadeInUp" data-wow-duration="4s">
			...
			<div class="leave_Word_box">
				<div class="leave_1 wow fadeInUp" data-wow-duration="4s">
					<form action="/QM/Comment" method="post">
						<textarea class="textarea_1" id="textarea_1" name="comment"
							rows="10" cols="110" placeholder="请输入您的留言^_^"></textarea>
						<br> <input type="submit" value="发表留言" class="leave_btn fr"
							id="leave_btn">
					</form>
				</div>
				
				<div class="leave_2 wow fadeInUp" data-wow-duration="4s" id="leave_2">
					<c:forEach items="${requestScope.list}" var="item">
						<p class="p14">
							<span class="constomer_id" id="constomer_id">${item.username}:</span> 
							<span class="leave_content" id="leave_content">${item.text}</span> 
							<span class="leave_time" id="leave_time">${item.time }</span>
						</p>
					</c:forEach>
				</div>

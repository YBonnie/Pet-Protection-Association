		...
		<script>
			function changePage(obj){
  			if(isNaN(obj.value)){
  				...
  				window.location.href="/QM/LoveAdoption?thispage="+obj.value;
  			}
  		}
		</script>
...
<body>
			...
			<div class="love_adoption wow fadeInUp" data-wow-duration="3s">
				...
				<div class="ep-pages wow fadeInUp" data-wow-duration="3s">		
					  	...
					  	<a href="/QM/LoveAdoption?thispage=${page.firstpage}">首页</a>
					  	<a href="/QM/LoveAdoption?thispage=${page.prepage}">上一页</a>
					  	...
					  	<c:forEach begin="${begin}" end="${end}" step="1" var="i">
					  		...
					  		<c:if test="${i != page.thispage}">
					  			<a href="/QM/LoveAdoption?thispage=${i}">${i }</a>
					  		</c:if>
					  	</c:forEach>
					  	
					  	<!-- 分页逻辑结束 -->
					  	
					  	<a href="/QM/LoveAdoption?thispage=${page.nextpage }">下一页</a>
					  	<a href="/QM/LoveAdoption?thispage=${page.lastpage }">尾页</a>

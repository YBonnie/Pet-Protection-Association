		...
		<script>
			function changePage(obj){
  			if(isNaN(obj.value)){
  				...
  				window.location.href="/QM/NewsList?thispage="+obj.value;
  			}
  		}
		</script>
...
<body>
			...
			<div class="breadcrumbs wow bounceInLeft" data-wow-duration="2s">
				<a href="/QM/IndexList">&nbsp;&nbsp;首页&nbsp;&nbsp;</a>
				<span> > </span>
				<a class="active" href="/QM/NewsList?thispage=1">&nbsp;&nbsp;新闻中心&nbsp;&nbsp;</a>
			</div>
			...
			<div class="content wow fadeInUp" data-wow-duration="4s">
				<div class="new_box">
					...
					<c:forEach items="${requestScope.page.list}" var="news">
						<li class="">
							<a href="/QM/newsContent?id=${news.id}" target="_blank">
								<img src="/QM/ImgServlet?imgurl=${news.news_img }" width="234" height="159" >
								<p class="news-title">
									${news.news_titles }
								</p>
								<p class="news-time">
				...
				<div class="ep-pages wow fadeInUp" data-wow-duration="2s">
					  	...
					  	<a href="/QM/NewsList?thispage=${page.firstpage}">首页</a>
					  	<a href="/QM/NewsList?thispage=${page.prepage}">上一页</a>
					  	...
					  	<c:forEach begin="${begin}" end="${end}" step="1" var="i">
					  		...
					  		<c:if test="${i != page.thispage}">
					  			<a href="/QM/NewsList?thispage=${i}">${i }</a>
					  		</c:if>
					  	</c:forEach>
					  	
					  	<!-- 分页逻辑结束 -->
					  	
					  	<a href="/QM/NewsList?thispage=${page.nextpage }">下一页</a>
					  	<a href="/QM/NewsList?thispage=${page.lastpage }">尾页</a>
					...
					<!--  
						<a href="news_Center.html">首页</a>
						<a href="news_Center.html" target="_self" class="ep-pages-ctrl">&lt;</a>
						<a href="news_Center.html" target="_self">1</a>
						<a href="javascript:#" target="_self" class="current">2</a>
						<a href="index_3.htm#news_content_id" target="_self">3</a>
						<span>...</span>
						<a href="index_3.htm#news_content_id" target="_self" class="ep-pages-ctrl">&gt;</a>
						<a href="index_11.htm#news_content_id" target="_self">尾页</a>
						-->
					</div>
				</div>
			</div>

		...
		<script>
			function changePage(obj){
  			if(isNaN(obj.value)){
  				...
  				window.location.href="/QM/PageCustServlet?thispage="+obj.value;
  			}
  		}
		</script>
</head>
			...
			<div class="content wow fadeInUp" data-wow-duration="4s">
				<div class="new_box">
					...
					<div class="ep-pages wow fadeInUp" data-wow-duration="2s">
					  	...
					  	<a href="/QM/PageCustServlet?thispage=${page.firstpage}">首页</a>
					  	<a href="/QM/PageCustServlet?thispage=${page.prepage}">上一页</a>
					  	...
					  	<c:forEach begin="${begin}" end="${end}" step="1" var="i">
					  		...
					  		<c:if test="${i != page.thispage}">
					  			<a href="/QM/PageCustServlet?thispage=${i}">${i }</a>
					  		</c:if>
					  	</c:forEach>
					  	
					  	<!-- 分页逻辑结束 -->
					  	
					  	<a href="/QM/PageCustServlet?thispage=${page.nextpage }">下一页</a>
					  	<a href="/QM/PageCustServlet?thispage=${page.lastpage }">尾页</a>

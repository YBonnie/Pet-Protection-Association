...
<script src="js/indexWow.js"></script>
	    ...
	    <script src="js/become_big.js" type="text/javascript" charset="utf-8"></script>
...
<body>
			...
			<div class="content wow fadeInUp" data-wow-duration="4s">
				<h1 class="wow bounceInLeft" data-wow-duration="3s">商品详情</h1>
				<div class="Commodity_box wow fadeInUp" data-wow-duration="4s">
					<div class="Commodity_details_box fl" id="Commodity_details_box">
						<img class="s_img" src="/QM/ImgServlet?imgurl=${requestScope.good.imgurl}" alt="" />
						<div id="move" class="move"></div>
						<div id="bimg" class="bimg">
							<img id="b_bimg" src="/QM/ImgServlet?imgurl=${requestScope.good.imgurl}" alt="#">
						</div>
					</div>

					<div class="Commodity_details_info fl">
						<form action="">
							<p class="p4"><span>二 手</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>${requestScope.good.name}</span></p>
							<p class="p5"><span>价格</span><span>¥ ${requestScope.good.price}</span></p>
							<div class="number">							 	
								<span class="kucun" id=""> 库 存 <b style="color:red;">${requestScope.good.total_number}</b> 件
								</span>
							</div>
							<div class="car_btn">
							<a href="/QM/AddShoppingCar?id=${requestScope.good.id}"><input type="button" name="" id="shopping_car" class="shopping_car" value="加入购物车" /></a>
							<a href="/QM/OrderListServlet" class="shopping_car_btn"><img src="media/images/shopping_car.jpg" alt="" /></a>
							</div>

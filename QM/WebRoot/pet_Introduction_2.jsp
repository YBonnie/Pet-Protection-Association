...
<script>
			function changePage(obj){
  			if(isNaN(obj.value)){
  				...
  				window.location.href="/QM/FindPets_1?thispage="+obj.value;
  			}
  		}
...
<body>
	...
	<div class="main">
		...
		<div class="ep-pages wow fadeInUp" data-wow-duration="2s">	
					  	...
					  	<a href="/QM/FindPets_1?thispage=${page.firstpage}">首页</a>
					  	<a href="/QM/FindPets_1?thispage=${page.prepage}">上一页</a>
					  	...
					  	<c:forEach begin="${begin}" end="${end}" step="1" var="i">
					  		...
					  		<c:if test="${i != page.thispage}">
					  			<a href="/QM/FindPets_1?thispage=${i}">${i }</a>
					  		</c:if>
					  	</c:forEach>
					  	
					  	<!-- 分页逻辑结束 -->
					  	
					  	<a href="/QM/FindPets_1?thispage=${page.nextpage }">下一页</a>
					  	<a href="/QM/FindPets_1?thispage=${page.lastpage }">尾页</a>

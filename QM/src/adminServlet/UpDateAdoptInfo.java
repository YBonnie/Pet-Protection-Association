...
public class UpDateAdoptInfo extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			BeanUtils.populate(adopt, request.getParameterMap());
			//2.调用Service中修改客户信息的方法
			service.AdminupdateAdoption(adopt);
			JOptionPane.showMessageDialog(null, "修改成功", "提示",JOptionPane.PLAIN_MESSAGE);
			//3.重定向到客户列表页面
			response.setHeader("Refresh", "2;url=/QM/AdminAdoptionServlet");
